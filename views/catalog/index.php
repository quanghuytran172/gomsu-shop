...
$(document).ready(function() {
    ...
    $('#getNext').click(function(e) {
        var catId = $('#getNext').attr('data_id');
...
<div class="container-fluid banner">
    <div class="container">
        ...
        <div class="banner-content">
            <h1><?php echo $data['currentCat']['cat_name'] ?></h1>
            <nav aria-label="breadcrumb " class="breadcrumb-fix mt-3">
                <ol class="breadcrumb breadcrumb-wrapped ">
                    ...
                    <li class='breadcrumb-item active' aria-current='page'>
                        <span><?php echo $data['currentCat']['cat_name'] ?></span>
                    </li>
                </ol>
            </nav>
    ...
    <div class="main-show flex-lg-row flex-column">
        <div class="col-lg-3 col-12 clo-box">
            ...
            if (isset($data['category_list'])) {
                categoryParent($data['category_list']);
            }
            ?>
        ...
        <div class="col-lg-9 col-12 intro-box">
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-sm-6 column-fixed">
                    <p style="margin: 21px 0">Có tất cả <?php echo $data['totalProduct'] ?> sản phẩm</p>
                </div>
            </div>
            <div class="cart">
            ...
            <div class="text-center mt-3 button-load">
                ...
                <div class="btn" style="background-color: #45526c; color: #fff" id="getNext"
                    total_product="<?php echo $data['totalProduct'] ?>"
                    data_id="<?php echo $data['currentCat']['cat_id'] ?>"><span style="font-size:15px">Load More</span>
                </div>
