                    ...
                    <form method="post" action="" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name='product_code' id="productcode"
                                    placeholder="Nhập mã sản phẩm" value="<?php echo $productData['product_code'] ?>">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="productname">Tên sản phẩm</label>
                                <input type="text" class="form-control" name='product_name' id="productname"
                                    placeholder="Nhập tên sản phẩm" value="<?php echo $productData['product_name'] ?>">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name='price' id="priceproduct"
                                    placeholder="Nhập giá sản phẩm đã sale" value="<?php echo $productData['price'] ?>">
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name='price_old' id="priceoldproduct"
                                    ...
                                    value="<?php echo $productData['price_old'] ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <input name="featured_product" type="checkbox" value="" id="defaultCheck1"
                                <?php if ($productData['featured_product'] == '1') echo "checked='checked'"; ?>>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name='quantity' id="quantityproduct"
                                placeholder="Nhập số lượng sản phẩm" value="<?php echo $productData['quantity'] ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="cParent" name="cat_id">
                                <?php
                                cate_parent($data['parent_id'], 0, '--', $data['productData']['cat_id']);
                                ?>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name='tag_name' id="tagname"
                                placeholder="Nhập tag name sản phẩm" value="<?php echo $productData['tag_name'] ?>">
                        </div>
                        ...
                        <div class="preview-images-zone">
                            <?php
                            $num = 1;
                            if (mysqli_num_rows($imagesData) > 0) {
                                while ($row = mysqli_fetch_assoc($imagesData)) {
                                    echo "
                                    <div class='preview-image preview-show-${num}'>
                                    <div class='image-cancel' data-no=${num}>x</div>
                                    <div class='image-zone'><img id='pro-img-${num}' src='upload/images/products/${row['file_name']}'>
                                    </div>
                        ...
                        <div class="form-footer pt-4 pt-5 mt-4 border-top">
                            <button type="submit" name="submit" class="btn btn-primary btn-default">Cập nhật</button>
