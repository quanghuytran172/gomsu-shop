                    ...
                    <form method="post" action="">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="cParent" name="parent_id">
                                ...
                                <?php
                                cate_parent($data['parentData'], 0, '--', $data['categoryData']['parent_id']);
                                ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name='cat_name' id="exampleFormControlInput1"
                                value="<?php echo $data['categoryData']['cat_name'] ?>">
                        </div>


                        <div class="form-footer pt-4 pt-5 mt-4 border-top">
                            <button type="submit" name="submit" class="btn btn-primary btn-default">Cập nhật</button>
                            <a href="admincategory" type="submit" class="btn btn-secondary btn-default">Hủy</a>
                        </div>
                    </form>
                </div>
            </div>
